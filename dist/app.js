...
function openSong() {
  openModal(`<article class="story-modal"><p class="modal-eyebrow">Melodia miasta</p><h2>♫ Muzyka i teledyski Dorszolandii</h2><p>Wszystkie nagrania są zapisane bezpośrednio w Dorszolandii i odtwarzają się bez przechodzenia na Dysk.</p><section class="song-player"><h3>Teledysk: Dorszolandia</h3><video controls preload="metadata" poster="assets/hero/dorszolandia-hero-original.webp"><source src="assets/music/kopia-dorszolandia.mp4" type="video/mp4" />Twoja przeglądarka nie obsługuje odtwarzania filmu.</video></section><section class="song-player"><h3>Piosenka Dorszolandii</h3><video controls preload="metadata"><source src="assets/stories/piosenka-dorszolandii.mp4" type="video/mp4" />Twoja przeglądarka nie obsługuje odtwarzania filmu.</video></section><section class="song-player"><h3>Piosenka Dorszolandii 2</h3><audio controls preload="metadata"><source src="assets/songs/dorszolandia-2.mp3" type="audio/mpeg" />Twoja przeglądarka nie obsługuje odtwarzania dźwięku.</audio></section><section class="song-player"><h3>Piosenka Dorszolandii 3</h3><audio controls preload="metadata"><source src="assets/songs/dorszolandia-3.mp3" type="audio/mpeg" />Twoja przeglądarka nie obsługuje odtwarzania dźwięku.</audio></section></article>`);
}
