...
const dorszopediaEntries = [
  ...
  { id: 'historie', icon: '📚', category: 'Bohaterowie', title: 'Jak czytać opowiadania Dorszo-Kumpli', intro: 'Każda ukończona historia ma bohaterów, zagadkę, decyzję i zakończenie.', body: ['W bibliotece znajdziesz pełne rozdziały pięciu historii: o Złotym Pęcherzu, znikających plecakach, Algorii, Dzwonie Portu i nocnej mapie Lasu Wodorostów. Po każdym rozdziale warto zatrzymać się na chwilę i zapytać: kto miał problem, kto pomógł i dlaczego wybrane rozwiązanie było życzliwe?', 'Historie uczą przez przygodę, a nie przez straszenie. Nawet gdy bohaterowie się mylą, mogą porozmawiać, przeprosić, poprawić plan i wrócić do wspólnego działania.'], facts: ['Wszystkie historie mają zakończenie.', 'Dorszuś i Borys są częścią miasta Króla Dorsza.'] },
...
function init() {
  renderResidents(); renderMap(); renderAdventures(); renderDorszopedia(); resetMemory(); newQuiz(); setUpDifferences(); renderAccessories(); renderCourt(); setUpEvents();
}
